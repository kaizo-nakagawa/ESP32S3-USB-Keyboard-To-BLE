...
#define TFT_ROTATION 2 // Flip y axis display 180 degrees
...
// For ESP32 S3 with ST7789 display (172x320) using HSPI
// HSPI (SPI3) is more reliable than VSPI on ESP32-S3 with core 3.0.0+
